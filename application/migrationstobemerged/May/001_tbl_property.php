 ...
 *
 * Multiple table add/update query (basically merged of multiple migration)
 *
...
class Migration_Tbl_property extends CI_Migration
{
    ...
    public function up()
	{
		...
		$migrationquery	=  'ALTER TABLE tbl_property ADD COLUMN `standard_price_night` float(10,2) NOT NULL AFTER `custom_url`,
