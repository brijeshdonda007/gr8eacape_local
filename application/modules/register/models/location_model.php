...
class Location_model extends CI_Model {	
	...
	function deleteCountry(){
        ...
        function getServiceCountries()

        {

                $sql = "Select b.*, a.country_name as country_name from tbl_country a inner join tbl_servrice_country b on b.country_id=a.id";
...

        {
             ...
             $sql = "select * from tbl_users_country order by id asc";
