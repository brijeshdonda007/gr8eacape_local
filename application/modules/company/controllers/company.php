...
class Company extends CI_Controller{
	...
	function index(){
        $data['user_profile_info']                      = $this->company_model->getUserInfo($this->session->userdata('user_id'));
        $data['company']                            =   $this->company_model->getcompany(10);
        $data['main_client_view']                   =      'company/company';
