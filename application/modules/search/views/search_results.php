...
<div class="count_results"><img src="<?php echo base_url(); ?>assets/frontend/images/search-home.png" /><span class="result-first"><?php echo ((@$total_num_search > 0)?@$total_num_search:'No');?></span> escapes found <?php if(@$keywords) {?>in <span class="result-last"><?php echo $this->search_model->capitalizeWords(@$keywords);?></span><?php }?></div>

<?php

    if((@$total_num_search) > 0)
    ...
    ?>
    	...
    	<ul class="widgets">
...

            {
                ...
                $owner_detail = $this->search_model->getOwnerByID($pl->owner_id);
...
#           if($pl->admin_action == 'verified'){$pink_tick_class = 'pinkTick';}
        ...
        <li class="span3 <?php echo @$liclass;?>">
          ...
          <div class="owner"> <a href="<?php echo site_url('owner/detail/'.$pl->owner_id)?>"><img src="<?php echo base_url(); ?>images/profile_img/thumb/<?php echo $owner_detail->profile_picture;?>" alt="profile" /> <?php echo $owner_detail->first_name;?> </a> </div>
