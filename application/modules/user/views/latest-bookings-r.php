...
{
?>
<div class="Block clearfix"> <a href="<?php echo site_url('user/allbookings');?>" class="pull-right"><strong>VIEW ALL</strong></a>          <h4>Latest Booking Requests</h4>          <table class="table table-striped latest-r">            <thead>              <tr>
                <th>ID</th>
    			<th>Property Name</th>
                <th>Guest Name</th>
                <th>Check In</th>
              ...
              <tr>
                ...
                <td><a href="<?php echo site_url('escapedetails/'.$br->url);?>"><?php echo @$br->prop_name;?></a></td>
                 <?php if(!empty($usrx)): ?>
                 <td><a href="<?php echo site_url('buyer/detail/'.$usrx->id)?>"><?php echo @$usrx->first_name.' '.@$usrx->last_name;?></a></td>                <td><?php echo $start_date;?></td>
                 <?php else: ?>
                 <td></td>
                 <?php endif ?>
