    ...
    <div class="wrapper clearfix">
        <div class="pull-left span4">
            ...
            <div class="profileName"> <span>Welcome</span><br />
                ...
                <br />
                <a href="<?php echo site_url('guest/editProfile');?>">Edit My Profile</a> </div>
            </div>

        <div class="pull-right userNav">
            <ul>

                <li><a href="<?php echo site_url('guest') ?>"><img src="<?php echo base_url(); ?>assets/frontend/images/dashboard.jpg" alt="dashboard" /> My Dashboard</a></li>
                ...
                if(@$this->earnings->grand_total) {
                    ...
                    <li><a href="<?php echo site_url('guest/allTransCurrMnth');?>"><img src="<?php echo base_url(); ?>assets/frontend/images/earning.jpg" alt="earning" /> EarNing: <span>$ <?php echo $eactual_earns_header; ?> NZ</span></a></li>
                <?php } ?>
            </ul>
        </div>
    </div>
