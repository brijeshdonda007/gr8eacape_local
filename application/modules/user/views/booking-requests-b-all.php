          ...
          <table class="table table-striped latest-c">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="<?php echo site_url('escapedetails/index/'.$br->property_id);?>"><?php echo $propx->title;?></a></td>
              ...
              <td>
                    ...
                    <div class="hyperlink"><img src="<?php echo base_url(); ?>assets/frontend/images/pending.png" alt="cross" class="pull-left" /> <a href="<?php echo site_url('user/cancelBookingByOwner/'.$br->id);?>">Cancel Booking</a></div>
                ...
                <div class="hyperlink"><img src="<?php echo base_url(); ?>assets/frontend/images/cross.png" alt="cross" class="pull-left" /> <a href="<?php echo site_url('user/deleteBookingBuyera/'.$br->id);?>">Delete</a></div>
                ...
                <div class="hyperlink"> <img src="<?php echo base_url(); ?>assets/frontend/images/tick.png" alt="cross" class="pull-left" /> <a href="#">Pay Now</a> </div>
