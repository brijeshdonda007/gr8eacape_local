...
<div class="Block clearfix">
	<div class="row-fluid clearfix">
    	...
    	<div class="span2 marginNone"> 
			...
			<?php } ?>
			<?php if($user_profile_info->user_type == 2){ ?>
			<div class="stars-overall-top" style="margin-top: 10px; clear: both;"><?php echo (@$user_ratings);?></div>
			<?php } else { ?>
			<?php
			$total_avgl = 0;
...
<?php
if($user_profile_info->user_type == 2)
{
?>
<?php $this->load->view('user/latest-bookings-r');?>
<?php $this->load->view('user/latest-property-lists');?>
<?php $this->load->view('user/latest-confirmed-booking-r');?>
<?php
}
elseif($user_profile_info->user_type == 1)
{
    $this->load->view('user/booking-requests-buyer');
}
?>
<script>
jQuery(function() {
