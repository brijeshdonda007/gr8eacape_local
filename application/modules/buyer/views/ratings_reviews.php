    ...
    <td colspan="5">&nbsp;</td>
...

              {
...

                  {
...

                      {
                         ...
                         $imgsrc =  base_url() . "images/profile_img/thumb/" . $ear->upic;
            ...
            <div class="media">
              ...
              <a class="pull-left" href="#">
                ...
                <img class="media-object" src="<?php echo $imgsrc;?>" alt="64x64">

              </a>

              <div class="media-body">

                <h4 class="media-heading"><a href="<?php echo site_url('owner/detail/'.$ear->uid);?>"><?php echo $ear->ufname.' '.$ear->ulname;?></a> <div class="date"><?php echo date('d/m/Y', strtotime($ear->created_date));?></div></h4>
        ...
        if($this->session->userdata('user_id') and $has_booked_by_user)
...
<?php
      ...
      $i=1; 
...

       {
           ...
           $israted = $this->buyer_model->isRatedByUsr($this->uri->segment(3), $rc->id);
...
<tr>
              ...
              <form name="prop_review" id="prop_review" method="post" action="<?php echo site_url('buyer/reviews');?>">
