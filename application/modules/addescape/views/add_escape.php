...
<section id="content">
    <div class="wrapper clearfix">
		...
		<form id="form-3-splited" method="post" class="profileform wizard" action="<?php echo base_url('Addescape/updateEscape'); ?><?php if(isset($property_code)) { echo "/".$property_code;}?>" enctype="multipart/form-data">
                ...
                <fieldset id="escape_sky_channel_wrap">
					...
					if(!empty($skyChannel)){
						foreach($skyChannel as $sky){ ?>
						   ...
						   if($this->uri->segment(2)){ if($channel->television_type == $sky->id)
...
<!-- -                                    <input type="checkbox" data-value="<?php echo @$channel->name; ?>" name="channels[]" class="property_category" value="<?php echo $channel->id;?>" /> <?php echo @$channel->name; ?>
 +                                     --><input type="checkbox" value="<?php echo @$channel->id ; ?>" data-value="<?php echo @$channel->name; ?>" name="channels[]" class="property_channels <?php echo @$sky->id ; ?>_property_channels" <?php if($this->uri->segment(2)){ if(in_array(@$channel->id, @$prop_sky_channel)){ echo 'checked';}}?> id="<?php echo @$channel->id."_"."channel"; ?>" /> <?php echo @$channel->name; ?>
                                                </fieldset>
            <?php endif ?>
        <?php endforeach ?>
                                    </div>
...
//                        });
                    ...
                    $(document).ready(function(){
                        ...
                        $('#add_images').click(function(){	
                            ...
                            $("#upload").attr("action",  base_url +'Addescape/uploadEscapeImages?id=' + escape_id);
