            ...
            <div class="panel-body">
                ...
                {?>
                    <table class="table-striped table-bordered table-hover" id="datatable" cellpadding="0" cellspacing="0">
                        <thead>
                            <tr>
                                <th><input type="checkbox" name="check_all" id="check_all" style="margin-right:10px;" />Escape</th>
                                <th>Owner</th>
                                <th>PG Url</th>
                                <th>Added On</th>
                                <th>Status</th>
                        ...
                        <tr <?php if($sn%2 == 0) {  echo 'class="tablealternate"'; }?>>
                            <td><input type="checkbox" class="escape_check" id="<?php echo $alp->id; ?>" style="margin-right:10px;"/><?php echo $alp->title;?></td>
