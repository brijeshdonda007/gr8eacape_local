<script type="text/javascript" src="<?php echo base_url() ?>assets/mini-file-uploader/js/jquery.fileupload.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/mini-file-uploader/js/jquery.iframe-transport.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/mini-file-uploader/js/jquery.knob.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/mini-file-uploader/js/jquery.ui.widget.js"></script>
<script type="text/javascript" src="<?php echo base_url() ?>assets/mini-file-uploader/js/script.js"></script>
<link href="<?php echo base_url() ?>assets/mini-file-uploader/css/style.css" rel="stylesheet" type="text/css">
...
<script type="text/javascript">
    var form_mode  = '';
    <?php if(@$property_info):?> form_mode  = 'EDIT'; <?php endif ?>
...
<section id="content">
    <div class="wrapper clearfix">
        ...
        <h2 style="float:left;">Editing <?php echo $property_info->title;?></h2><h4 style="float:right;line-height:40px;">Please provide the required(<span class="red">*</span>) fields to list your escape!</h4><div class="clear"></div>
        <?php }
		 else {
		...
		<form id="form-3-splited" method="post" class="profileform wizard" action="<?php echo base_url('owner/escape/update'); ?>" enctype="multipart/form-data">
            <input type="hidden" name="save_property_id"  id="save_property_id" value="<?php echo @$property_info->id ?>">
            <input type="hidden" name="property_status"  id="property_status" value="<?php echo @$property_info->property_status ?>">
            <input type="hidden" name="admin_action"  id="admin_action" value="<?php echo @$property_info->admin_action ?>">
		...
		<input type="hidden" name="summer_rate_original" id="summer_rate_original" value="<?php echo @$property_info->summer_rate;?>" />
            ...
            <h3>General</h3>			
            <article>
             <h3 style="color:#2184be" >General</h3>			
                <div class="left">
    ...
    ?>
                    ...
                    <fieldset id="children_wrap" class="radio-fix">
                        ...
                        <input type="radio" class="children_radio" name="children" id="children_allowed" value="0" <?php if (@$property_info->children == '0') echo 'checked="checked"'; ?> />No
                    </fieldset>
                    ...
                    <fieldset id="pet_wrap" class="radio-fix">
                        ...
                        <input type="radio"  class ="pet_radio" name="pet" id="pet_allowed_0" value="0" <?php if (@$property_info->pet == '0') echo 'checked="checked"'; ?> />No
                    </fieldset>
...
?>
                    ...
                    <fieldset id="smoking_wrap" class="radio-fix">
                        ...
                        <input type="radio" class ="smoking_radio"  name="smoking" id="smoking" value="3"  <?php if (@$property_info->smoking == '3') echo 'checked="checked"' ?> />Not on property
                    </fieldset>
                    <fieldset id="photographer_wrap" class="radio-fix">
                        ...
                        <input type="radio"  class ="photographer_radio" name="photographer" id="photographer" value="0" <?php if (@$property_info->photographer == '0') echo 'checked="checked"' ?> />Not required
                    </fieldset>
...
<?php } ?>
                        <div id="text">
                            <input name="property_video" id="property_video" type="text" value="<?php echo @$property_info->youtube_video_id; ?>"/>
                                        ...
                                        <!--escape phone-->
                    <div id="escape_phone_wrap">
                        <fieldset id="escape_phone_id" class="radio-fix">
                            <label class="control-label"> Does this escape have a phone ? <span>*</span></label>
                            <input type="radio" name="escape_phone_radio"  class="escape_phone_radio" id="escape_phone_yes" value="1" <?php if (isset($property_info) && !empty($property_info->phone)) echo 'checked="checked"'; ?>>  Yes
                            <input type="radio" name="escape_phone_radio"  class="escape_phone_radio" id="escape_phone_no" value="0" <?php if (isset($property_info) && empty($property_info->phone)) echo 'checked="checked"'; ?>> No
                        </fieldset>
                    </div>
                    <?php
@$esc_phone_style = '';
@$esc_phone = '';
if (isset($property_info) && !empty($property_info->phone)) {
    $esc_phone_style = '';
    $esc_phone = @$property_info->phone;
} else {
    $esc_phone_style = 'style="display:none;"';
    $esc_phone = '';
}
?>
                    <div id="escape_phone" <?php echo $esc_phone_style; ?>>
                        <fieldset>
                            <label class="control-label">Escape Phone<span>*</span></label>
                            <input type="text" name="escape_phone" id="escape_phone_value" value="<?php echo $esc_phone; ?>" onblur="$('.error').hide();" onclick="$('.error').hide();">
                        </fieldset>
                    </div>
                    <!--escape phone ends-->
...
?>
                ...
                <div align="right" id="save_div" >
                    <fieldset>
                        <input type="button" name="save_button" value="Save Information" id="save_button" onclick="saveEscape(0, <?php echo $is_edit ?>);" style="width:150px">
                    </fieldset>
                </div> 
            ...
            <h3>Rates</h3>
            <article>
               <h3 style="color:#2184be" >Rates</h3>
               <p>All rates below include GST</p>
				...
				if(@$property_info->price_night > 0) {
					$price_night_style = '';
					$price_night_check="checked";
					
					}
				else {
					$price_night_style = 'style="display:none;"';
					$price_night_check="";
					}
					
				if(@$property_info->price_week > 0) {
					$price_week_style = '';
					$price_week_check="checked";
					}
				else {
					$price_week_style = 'style="display:none;"';
					$price_week_check="";
					}
					
				if(@$property_info->price_month > 0) {
					$price_month_style = '';
					$price_month_check="checked";
					}
				else {
					$price_month_style = 'style="display:none;"';
					$price_month_check="";
					}
                ...
                <div class="price-gr">
                    <fieldset id="group-standard-1" class="radio-fix">
                        <input type="checkbox" <?php echo $price_night_check; ?> name="standard_rate_group_1" id="standard_rate_group_1" />
                        <label class="control-label">Rate Per Night</label>
                    </fieldset>				
                    <fieldset id="price_night_wrap" <?php echo $price_night_style ;?>>	                    
                        <input type="text" placeholder="" class="input-large numberinput" name="price_night" id="price_night" style="width:70px;" value="<?php echo @$property_info->price_night; ?>">
                    </fieldset>
                </div>
                <div class="price-gr">
                    <fieldset id="group-standard-2" class="radio-fix">
                        <input type="checkbox" <?php echo $price_week_check; ?> name="standard_rate_group_2" id="standard_rate_group_2" />
                        <label class="control-label">Rate Per Week</label>
                    </fieldset>	
                    <fieldset id="price_week_wrap" <?php echo $price_week_style ;?> >	                   
                        <input type="text" placeholder="" class="input-large numberinput" name="price_week" id="price_week" style="width:70px;" value="<?php echo @$property_info->price_week; ?>">
                    </fieldset>
                </div>
                <div class="price-gr">
                    <fieldset id="group-standard-3" class="radio-fix">
                        <input type="checkbox" <?php echo $price_month_check; ?> name="standard_rate_group_2" id="standard_rate_group_3" />
                        <label class="control-label">Rate Per Month</label>
                    </fieldset>	
                    <fieldset id="price_month_wrap" <?php echo $price_month_style ;?>>                  
                        <input type="text" placeholder="" class="input-large numberinput" name="price_month" id="price_month" style="width:70px;"  value="<?php echo @$property_info->price_month; ?>">
                    </fieldset>  
                </div>          	
				<h4 style="color:#2184be" >Seasonal Rates</h4>
...
?>
                    <div id="winter_rate_wrap">
                        ...
                        <fieldset class="radio-fix check-fix" >
						...
						<div id="winter_rate_div" <?php echo $winter_style ;?> >
                            <fieldset >
                                <label class="control-label price-group">Start Date :<span>*</span></label>
								<input type="text" name="winter_start_date" id="winter_start_date" style="width:70px;" value="<?php echo $winter_start_date ;?>" onclick='$(".error").hide();' rel="datepicker_start">
                            </fieldset>
                            <fieldset >
                                <label class="control-label price-group">End Date :<span>*</span></label>
								<input type="text" name="winter_end_date" id="winter_end_date" style="width:70px;" value="<?php echo $winter_end_date ;?>" onclick='$(".error").hide();' rel="datepicker_end">
                            </fieldset>
                        </div>
                    </div>
					<div id="winter_rate_div_price" <?php echo $winter_style ;?>>
                        ...
                        <fieldset>
                            <label class="control-label price-group">Rate per night :<span>*</span></label>
							<input type="text" name="winter_price_night" id="winter_price_night" style="width:70px;" value="<?php echo $winter_price_night;?>" onclick='$(".error").hide();'>
                        </fieldset>
                        <fieldset>
                            <label class="control-label price-group">Rate per week :<span>*</span></label>
							<input type="text" name="winter_price_week" id="winter_price_week" style="width:70px;" value="<?php echo $winter_price_week;?>" onclick='$(".error").hide();'>
                        </fieldset>
                        <fieldset>
                            <label class="control-label price-group">Rate per month :<span>*</span></label>
							<input type="text" name="winter_price_month" id="winter_price_month" style="width:70px;" value="<?php echo $winter_price_month;?>" onclick='$(".error").hide();'>
                        </fieldset>
                    </div>	
...
?>	
                    <div id="holiday_rate_wrap">
						...
						<div id="holiday_rate_div" <?php echo $holiday_style;?>>
                            <fieldset >								
                                <label class="control-label price-group"> Start Date :<span>*</span></label>								
								<input type="text" name="holiday_start_date" id="holiday_start_date" style="width:70px;" value="<?php echo $holiday_start_date ;?>" onclick='$(".error").hide();' rel="datepicker_start">
                            </fieldset>
                            <fieldset >
                                <label class="control-label price-group"> End Date :<span>*</span></label>								
								<input type="text" name="holiday_end_date" id="holiday_end_date" style="width:70px;" value="<?php echo $holiday_end_date ;?>" onclick='$(".error").hide();' rel="datepicker_end">								
                            </fieldset>
                        </div>
                        ...
                        <fieldset>
                            <label class="control-label price-group">Rate Per Night :<span>*</span></label>
								<input type="text" name="holiday_price_night" id="holiday_price_night" style="width:70px;" value="<?php echo $holiday_price_night;?>" onclick='$(".error").hide();'>
                        </fieldset>
                        <fieldset>
                            <label class="control-label price-group">Rate Per Week :<span>*</span></label>
								<input type="text" name="holiday_price_week" id="holiday_price_week" style="width:70px;" value="<?php echo $holiday_price_week;?>" onclick='$(".error").hide();'>
                        </fieldset>
                        <fieldset>
                            <label class="control-label price-group">Rate Per Month :<span>*</span></label>
								<input type="text" name="holiday_price_month" id="holiday_price_month" style="width:70px;" value="<?php echo $holiday_price_month;?>" onclick='$(".error").hide();'>
                        </fieldset>
                    </div>

					<?php 
                    if (@$property_info->summer_rate==1) { 
                    ...
                    <div id="summer_rate_wrap">	
                        ...
                        <div id="summer_rate_div" <?php echo $summer_style; ?>>
                            <fieldset >
                                <label class="control-label price-group"> Start Date :<span>*</span></label>
								<input type="text" name="summer_start_date" id="summer_start_date" style="width:70px;" value="<?php echo $summer_start_date ;?>" onclick='$(".error").hide();' rel="datepicker_start">
                            </fieldset>
                            <fieldset >
                                <label class="control-label price-group"> End Date :<span>*</span></label>
								<input type="text" name="summer_end_date" id="summer_end_date" style="width:70px;" value="<?php echo $summer_end_date ;?>" onclick='$(".error").hide();' rel="datepicker_end">
                            </fieldset>
                        </div>
                    ...
                    <!-- <fieldset id="summer_rate_div_price" class="radio-fix" <?php echo $summer_style; ?> >
                        ...
                        <fieldset>
                            <label class="control-label price-group">Rate Per Night :<span>*</span></label>
						<input type="text" name="summer_price_night" id="summer_price_night" style="width:70px;" value="<?php echo $summer_price_night;?>" onclick='$(".error").hide();'>
                        </fieldset>
                        <fieldset>
                            <label class="control-label price-group">Rate per Week :<span>*</span></label>
						<input type="text" name="summer_price_week" id="summer_price_week" style="width:70px;" value="<?php echo $summer_price_week;?>" onclick='$(".error").hide();'>
                        </fieldset>
                        <fieldset>
                            <label class="control-label price-group">Rate Per Month :<span>*</span></label>
						<input type="text" name="summer_price_month" id="summer_price_month" style="width:70px;" value="<?php echo $summer_price_month;?>" onclick='$(".error").hide();'>
                        </fieldset>
                    </div>

                </div>
                <h4 style="color:#2184be" >Booking Cancellation Policy</h4>
                <fieldset id="booking_cancellation_wrap" class="radio-fix check-fix">
                    <!-- <label class="control-label">Booking Cancellation Policy<span>*</span></label> -->
                    <div style="margin-bottom:10px;">
                    <input type="radio" class="booking_name_radio" name="booking_cancelation" value="0" <?php if (@$property_info->booking_cancelation == 0) echo 'checked="checked"'; ?>/><a href="javascript:void(0);" id="cancelation_reasonable">Reasonable</a>
                    </div>
                    
					 <div style="margin-bottom:10px;">		
                    <input type="radio" class="booking_name_radio"  name="booking_cancelation" value="1" <?php if (@$property_info->booking_cancelation == 1) echo 'checked="checked"'; ?> /><a href="javascript:void(0);" id="cancelation_relaxed">Relaxed</a>
					</div>
					 <div style="margin-bottom:10px;">
                    <input type="radio" class="booking_name_radio"  name="booking_cancelation" value="2" <?php if (@$property_info->booking_cancelation == 2) echo 'checked="checked"'; ?> /><a href="javascript:void(0);" id="cancelation_strict">Strict</a>
                    </div>

                </fieldset>
                <fieldset id="bond_wrap" class="radio-fix">
                    <label class="control-label price-group" style="width:170px">Bond:</label>
                    <div id="bond_val"><input type="text" name="bond_amount" id="bond_amount" value="<?php echo @$property_info->bond_amount; ?>"/></div>
                </fieldset>
                <fieldset id="min_nights_wrap" class="radio-fix">
                    <label class="control-label price-group" style="width:170px">Minimum Nights:</label>
                    <div id="min_night_val"><input type="text" name="min_nights" id="min_nights" value="<?php echo @$property_info->min_nights; ?>"/></div>
                </fieldset>
                <div align="right" id="save_price_div" >
                    <input type="button" name="save_price_button" value="Save Information" id="save_price_button" onclick="saveEscape(1, <?php echo $is_edit ?>);" style="width:150px">
                </div>  
            </article>

            <h3><span onclick="getLocationValues();">Location</span></h3>
            <article>
            <h3 style="color:#2184be" >Location</h3>
...
<?php } ?>
                ...
                <div align="right" id="save_location_div" >
                    <input type="button" name="save_location_button" value="Save Information" id="save_location_button" onclick="saveEscape(2, <?php echo $is_edit ?>);" style="width:150px">
                </div> 
            </article>

            <h3>Facilities</h3>
            <article>
            <h3 style="color:#2184be" >Facilities</h3>
                <fieldset id="amenities_wrap">
					 <label>Facilities:<span>*</span></label> <br />
...
<?php } ?>
                ...
                <div align="right" id="save_div" >
                    <input type="button" name="save_facility_button" value="Save Information" id="save_facility_button" onclick="saveEscape(3, <?php echo $is_edit ?>);" style="width:150px">
                </div>  
            </article>

            <h3>Categories</h3>
            <article>
            <h3 style="color:#2184be" >Categories</h3>
                <fieldset id="escape_category_wrap">
                    <label class="control-label">Categories:<span>*</span></label> <br />

                    <div class="property-category">
                    <?php foreach($categories as $cat){ ?>
                            <fieldset id="category_checkbox">
                          <input type="checkbox" data-value="<?php echo @$cat->category_title; ?>" id="<?php echo @$cat->id."_"."cat"; ?>" name="property_category[]" class="property_category" value="<?php echo $cat->id;?>" <?php if($this->uri->segment(4)){ if(in_array(@$cat->id, @$prop_cats)){ echo 'checked';}}?>><?php echo @$cat->category_title; ?>
                            </fieldset>
<?php } ?>
                    </div>
                </fieldset>
                <div align="right" id="save_cateory_div" >
                    <input type="button" name="save_category_button" value="Save Information" id="save_category_button" onclick="saveEscape(4, <?php echo $is_edit ?>);" style="width:150px">
                </div> 
            </article>
            <h3>Television</h3>
            <article>
			<h3 style="color:#2184be" >Television</h3>
                <label style="width:30px; !important ">Television:<span>*</span></label>
                ...
                <fieldset id="escape_sky_channel_wrap">
                    ...
                    <?php
					if(!empty($skyChannel)){
						foreach($skyChannel as $sky){ ?>
                                <fieldset id="sky_channel_checkbox" class="radio-fix">
                           <input onClick="getSkyChannel(<?php echo $sky->id;?>);" type="checkbox" data-value="<?php echo @$sky->tv_category; ?>" id="<?php echo @$sky->id."_"."sky"; ?>" name="property_sky_channel" class="property_sky_channel" value="<?php echo $sky->id;?>"   <?php 
						   $channel_display = 0;
						   foreach($freeviewChannel as $channel) {
						   if($this->uri->segment(4)){ if($channel->television_type == $sky->id)
						   	if(in_array(@$channel->id, @$prop_sky_channel)){ echo 'checked'; $channel_display = 1; break;} } }?> /><?php echo @$sky->tv_category; ?>
                                </fieldset>
                                <fieldset class="channel_<?php echo $sky->id ?>" <?php if(!$channel_display) { echo 'style="display:none;"'; } ?>  id="property_sky_channel_style">
                                    <div class="property-category">
                              <?php foreach($freeviewChannel as $channel): ?>
                                  <?php if($channel->television_type == $sky->id): ?>
                                                <fieldset id="category_checkbox">
<!-- -                                    <input type="checkbox" data-value="<?php echo @$channel->name; ?>" name="channels[]" class="property_category" value="<?php echo $channel->id;?>" /> <?php echo @$channel->name; ?>
 +                                     --><input type="checkbox" value="<?php echo @$channel->id ; ?>" data-value="<?php echo @$channel->name; ?>" name="channels[]" class="property_channels <?php echo @$sky->id ; ?>_property_channels" <?php if($this->uri->segment(4)){ if(in_array(@$channel->id, @$prop_sky_channel)){ echo 'checked';}}?> id="<?php echo @$channel->id."_"."channel"; ?>" /> <?php echo @$channel->name; ?>
                                                </fieldset>
            <?php endif ?>
        <?php endforeach ?>
                                    </div>
    ...
    <?php }
                ...
                <div align="right" id="save_cateory_div" >
                    <input type="button" name="save_sky_channel_button" value="Save Information" id="save_sky_channel_button" onclick="saveEscape(5, <?php echo $is_edit ?>);" style="width:150px">
                </div>  
            </article>
            <h3>Gallery</h3>
            <article>
            <h3 style="color:#2184be" >Gallery</h3>
            ...
            <h3>Finalize</h3>
            <article>
            <h3 style="color:#2184be" >Finalize</h3>
                ...
                <fieldset style="text-align:right;" class="">
				     <?php if (@$property_info){?>
...
<?php } ?>
                        ...
                        // phone
                        $('input[name=escape_phone_radio]').on('change', function(){
                            $('.error').hide();
                            $('#escape_phone_value').val('');
                            if ($(this).val() == '1'){
                                $('#escape_phone').show();
                            }else{
                                $('#escape_phone').hide();
...
//                        });
                    ...
                    $(document).ready(function(){
                        ...
                        $('#add_images').click(function(){	
                            ...
                            $("#upload").attr("action",  base_url +'owner/escape/upload?id=' + escape_id);
                            $('#dropzone_modal').modal();
                        });
                       // $("#form-3-splited-t-6").click(function(){
//                            $("#dropzone_modal").show();
//                        })
                        $("#form-3-splited-t-7,#form-3-splited-t-1,#form-3-splited-t-2,#form-3-splited-t-3,#form-3-splited-t-4,#form-3-splited-t-5,#form-3-splited-t-0").click(function(){
                            $("#dropzone_modal").hide();
                        })
                        $('.close_modal').click(function(){
                        ...
                        if(form_mode == 'EDIT'){
                            ...
                            getImageGallery(gallery_escape_id);
	 						...
	 						$('#form-3-splited-t-6').on('click', function() {
                        			...
                        			/** TO GENERATE ESCAPE ID TO UPLOAD IMAGES FOR SPECIFIC ESCAPE. **/
                        				$.post(base_url +"owner/escape/insert",function(data){
										var escape_id = data;
                    ...
                    function getImageGallery(id){
                        var escape_id = $('#save_property_id').val();
                        $.ajax({
                            url: base_url +"Addescape/getImageGallery?id=" + escape_id,
                            success: function(data) {
                    ...
                    function getSkyChannel(id) {
                        $('.channel_'+id).toggle();
                        $('.'+id+'_property_channels').each(function(){
