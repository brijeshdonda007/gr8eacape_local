...
class Destination extends CI_Controller{
	...
	function index(){
        $data['user_profile_info']                      = $this->destination_model->getUserInfo($this->session->userdata('user_id'));
        $data['destination']                            =   $this->destination_model->getdestination(11);
        $data['main_client_view']                   =      'destination/destinations';
        $data['page_title'] = 'Destinations';
