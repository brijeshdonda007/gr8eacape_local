...
class Content extends CI_Controller{
	...
	function view($id){
		@$content = $this->content_model->getcontentbyurl($id);

        $data['user_profile_info'] = $this->content_model->getUserInfo($this->session->userdata('user_id'));
        $data['content'] = $content;
        $data['main_client_view'] = 'content/view';
        $data['page_title'] = @$content->page_name;
