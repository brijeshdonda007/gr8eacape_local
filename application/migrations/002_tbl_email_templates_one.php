 ...
 */
class Migration_Tbl_email_templates_one extends CI_Migration
{

	public function up()
	{
            //pre_confirmation_email
            $migrationQuery = "INSERT INTO `dev_website`.`tbl_email_template` (`id`, `name`, `content`) VALUES (NULL, 'pre_confirmation_email', '<p>
                &nbsp;</p>
                <h2>
                 Dear $buyer_name,</h2>
                <p>
                 &nbsp;</p>
                <p>
                This email is an automatic email to let you know that we have received your pre confirmed booking for the following:</p>
                <p>
